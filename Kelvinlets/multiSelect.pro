...
HEADERS  = multiSelect.h manipulatedFrameSetConstraint.h object.h Mesh.h Vec3.h
SOURCES  = multiSelect.cpp manipulatedFrameSetConstraint.cpp object.cpp Mesh.cpp main.cpp
